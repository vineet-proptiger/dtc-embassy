      ...
      <div className="hero-content">
        <>
            ...
            <p className="hero-subtitle" data-aos="fade-right" data-aos-delay="100">
              <span style={{ fontSize: '0.85em', fontWeight: 500, textTransform: 'none' }}>At Rajarhat Main Road, Kolkata</span>
            </p>
            {/* Bullet Points */}
            <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                'Spacious Balcony & Private Garden',
                '4 & 5 BHK Villa - 150 Units Only',
                'Largest Clubhouse & Green Podium',
                'Private Sky-Light & Open Terrace'
              ].map((text, i) => (
