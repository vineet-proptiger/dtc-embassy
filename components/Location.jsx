...
const locationItems = [
  { name: 'NSCBI Airport', dist: '~15 mins' },
  { name: 'New Town IT Hub / Ecospace', dist: '~15 mins' },
  { name: 'Salt Lake Sector V', dist: '~20 mins' },
  { name: 'City Centre 2', dist: '~10 mins' },
  { name: 'Apollo Gleneagles Hospital', dist: '~25 mins' },
  { name: 'DPS Megacity School', dist: '~10 mins' },
  { name: 'Sealdah Railway Station', dist: '~30 mins' },
  { name: 'Rajarhat Chowmatha', dist: '~5 mins' },
]
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" data-aos-delay="150" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117842.69490388024!2d88.40838422250134!3d22.631996599999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f89fce103bdde5%3A0xfe7d6a4a297ddbb6!2sRajarhat%2C%20Kolkata%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1784349230825!5m2!1sen!2sin"
                width="100%"
                height="100%"
