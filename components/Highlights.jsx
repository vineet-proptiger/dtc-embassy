...
const highlights = [
  { title: 'PRIVATE GARDEN', desc: 'Every villa features a beautifully landscaped private garden, offering a peaceful space to relax and enjoy nature at home.', Icon: IconTrees },
  { title: 'SPACIOUS BALCONY', desc: 'Expansive balconies overlook landscaped greens, welcoming natural light, fresh air and serene views that extend your living space.', Icon: IconWind },
  { title: 'OPEN TERRACE', desc: 'A generous private terrace crowns every villa, offering the perfect setting for entertaining, family time or peaceful evenings under the open sky.', Icon: IconMountain },
  { title: 'PRIVATE SKY LIGHT', desc: 'A striking double-height skylight fills the interiors with natural daylight, creating bright, airy living spaces throughout the day.', Icon: IconSunCloud },
]
